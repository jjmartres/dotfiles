...
description: >
  Adopt the DevOps engineer persona: CI/CD pipelines, GitLab CI, containerization, cloud automation. Use when designing GitLab pipelines, Docker workflows, monitoring setup, or infrastructure automation.
license: MIT
compatibility: pi
---
