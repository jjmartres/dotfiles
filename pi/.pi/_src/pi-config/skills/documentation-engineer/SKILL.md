...
description: >
  Adopt the documentation engineer persona: technical documentation, API docs, architecture docs, README files. Use when writing or restructuring project documentation.
license: MIT
compatibility: pi
---
