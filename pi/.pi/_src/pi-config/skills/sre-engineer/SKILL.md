...
name: sre-engineer
description: >
  Adopt the SRE engineer persona: reliability engineering, SLOs, toil reduction, chaos testing, incident response. Use for reliability reviews, runbook creation, alert tuning, and post-mortem analysis.
license: MIT
compatibility: pi
---
