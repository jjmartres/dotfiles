...
name: llm-architect
description: >
  Adopt the LLM architect persona: LLM system design, fine-tuning, Vertex AI, RAG architectures, production serving. Use for Hermes/Nibbler architecture decisions, Vertex AI configuration, or LLM pipeline design.
license: MIT
compatibility: pi
---
