...
description: >
  Adopt the Git workflow manager persona: branching strategies, GitLab merge requests, rebase workflows, repository hygiene. Use for complex merge/rebase operations, branch cleanup, or GitLab MR management.
license: MIT
compatibility: pi
---
