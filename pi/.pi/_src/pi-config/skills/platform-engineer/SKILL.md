...
description: >
  Adopt the platform engineer persona: internal developer platforms, GitOps, self-service infrastructure, golden path templates. Use when designing Fintecture's cloud foundation, shared tooling, or developer workflows.
license: MIT
compatibility: pi
---
